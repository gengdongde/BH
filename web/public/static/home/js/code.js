...
document.writeln("        <ul>");
document.writeln("                        <li>");
document.writeln("                <a href=\"http://huzhu.wordyt.com/\" target=\"_blank\">");
document.writeln("                    <img src=\"//stats.chinaz.com/zx_g/wordyt1.png\" width=\"260\" height=\"150\" alt=\"\">");
document.writeln("                </a>");
document.writeln("                <div class=\"caption\">云广科技系统开发</div>");
document.writeln("            </li>");
document.writeln("                        <li>");
document.writeln("                <a href=\"http://www.kesion.com/\" target=\"_blank\">");
document.writeln("                    <img src=\"//stats.chinaz.com/code_img/images/kesionedu.gif\" width=\"260\" height=\"150\" alt=\"\">");
document.writeln("                </a>");
document.writeln("                <div class=\"caption\">科汛网校系统</div>");
document.writeln("            </li>");
document.writeln("                        <li>");
document.writeln("                <a href=\"http://www.52xinyou.com/\" target=\"_blank\">");
document.writeln("                    <img src=\"//stats.chinaz.com/newshome/52xinyou130.jpg\" width=\"260\" height=\"150\" alt=\"\">");
document.writeln("                </a>");
document.writeln("                <div class=\"caption\">信游页游平台管理系统</div>");
document.writeln("            </li>");
document.writeln("    </div>");
document.writeln("    <ul class=\"trigger\" id=\"trigger\">");
document.writeln("                <li onclick=\"slideshow.pos(0)\">1</li>");
document.writeln("                <li onclick=\"slideshow.pos(1)\">2</li>");
document.writeln("                <li onclick=\"slideshow.pos(2)\">3</li>");
document.writeln("            </ul>");
