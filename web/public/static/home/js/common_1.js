    ...
    $('.aTabLayout').each(function()
    {
        ...
        $('.loadingMore').each(function()
        {
            $(this).click(function()
            {
				...
				t.find('.aTabMain').find('.imgTxtBar li').show();
                ...
                {
            		var tLen = $('.aTabNav li.current').index()
					var arrhref = [
					'http://www.chinaz.com/news/roll',
					'http://www.chinaz.com/web/',
					'http://www.chinaz.com/manage/',
					'http://www.chinaz.com/start/',
					'http://www.chinaz.com/start/model/',
					'http://www.chinaz.com/biz/',
					'http://www.chinaz.com/mobile/',
					'http://www.chinaz.com/visit/',
					'http://www.chinaz.com/design/',
					'http://www.chinaz.com/game/',
					]
					aTxt.attr("href",arrhref[tLen])
                }
            });
        });    
    });
